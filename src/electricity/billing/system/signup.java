...
public class signup extends JFrame implements ActionListener {
    ...
    JTextField meternumberField, employeeField, usernameField, nameField;
        ...
        if (e.getSource() == createButton) {
            ...
            try {
                ...
                if (userType.equals("Admin")) {
                    query = "INSERT INTO signup (meter_number, username, name, password, userType) VALUES ('" + meternumber + "', '" + username + "', '" + name + "', '" + password + "', '" + userType + "')";
                } else {
                    query = "INSERT INTO signup (meter_number, username, password, userType) VALUES ('" + meternumber + "', '" + username + "', '" + password + "', '" + userType + "')";
                }
